        ...
        detachments: [
            {
                ...
                enhancements: [
                    { name: "Bearer of the Iron Chalice", cost: 20, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Bearer of the Evanescent Ion", cost: 15, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Bearer of the Judicant's Helm", cost: 25, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Bearer of the Lancer's Sigil", cost: 25, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Run Them Through!", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Thunderstomp", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Full Tilt", cp: 2, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Vow of Retribution", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Tactical Foil", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Rotate Ion Shields", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Acquisitor-at-Arms", cost: 15, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Purgation's Hand", cost: 20, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Augury Halo", cost: 20, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Vengeful Tread", cost: 15, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Drive Them Out!", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Lancebreaker", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Steadfast Superiority", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Marshal the Defence", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Titanic Bombardment", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Fortress of Intimidation", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Herald of Triumph", cost: 15, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Wyrmslayer Divination", cost: 10, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Pennant of Silvered Fury", cost: 15, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Crushing Condemnation", cost: 10, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Courageous Stand", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Titanic Duel", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Moment of Glory", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Hero's Tread", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Unstoppable Warrior", cp: 2, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Driven by the Past", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Mentor's Pride", cost: 20, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Fables of Nightmare", cost: 10, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Tales of Heroism", cost: 10, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Martial Tuition", cost: 15, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Virtue of Courage", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Exemplar's Wisdom", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Mantle of the Mentor", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Thin Their Ranks", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Let Duty Be Your Shield", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Squires of the Hunt", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Bringer of Justice", cost: 30, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Hunter's Eye", cost: 25, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Mysterious Guardian", cost: 35, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Sanctuary", cost: 20, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Noble Sacrifice", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Strength from Exile", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Full Tilt", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Point-blank Barrage", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Survivor of Strife", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Flanking Manoeuvres", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Omnissian Champion", cost: 30, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Knight of the Opus Machina", cost: 20, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                    { name: "Magos Questoris", cost: 35, restriction: "TECH-PRIEST model only.", text: "" },
                    { name: "Vocifer Magnificat (Aura)", cost: 15, restriction: "IMPERIAL KNIGHTS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Omnissiah's Grace", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Vengeance of the Machine Cult", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Bonded Imperative", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Machine Focus", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Aggression Begets Aggression", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Thronegheist Fury", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            }
        ],
        units: [
