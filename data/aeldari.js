        ...
        detachments: [
            {
                ...
                enhancements: [
                    { name: "Phoenix Gem", cost: 35, restriction: "ASURYANI model only.", text: "" },
                    { name: "Timeless Strategist", cost: 15, restriction: "ASURYANI model only.", text: "" },
                    { name: "Gift of Foresight", cost: 15, restriction: "ASURYANI model only.", text: "" },
                    { name: "Psychic Destroyer", cost: 30, restriction: "ASURYANI PSYKER model only.", text: "" },
                ],
                stratagems: [
                    { name: "Lightning-fast Reactions", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Skyborne Sanctuary", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Feigned Retreat", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Blitzing Firepower", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Fire and Fade", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Webway Tunnel", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                name: "Windrider Host",
                ...
                enhancements: [
                    { name: "Firstdrawn Blade", cost: 10, restriction: "ASURYANI MOUNTED model only.", text: "" },
                    { name: "Mirage Field", cost: 25, restriction: "ASURYANI MOUNTED model only.", text: "" },
                    { name: "Seersight Strike", cost: 15, restriction: "ASURYANI MOUNTED PSYKER model only.", text: "" },
                    { name: "Echoes of Ulthanesh", cost: 20, restriction: "ASURYANI MOUNTED model only.", text: "" },
                ],
                stratagems: [
                    { name: "Death from on High", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Overflight", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Wind of Blades", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Daring Riders", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Focused Firepower", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Spiralling Evasion", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Light of Clarity", cost: 30, restriction: "SPIRITSEER model only.", text: "" },
                    { name: "Stave of Kurnous", cost: 15, restriction: "SPIRITSEER model only.", text: "" },
                    { name: "Rune of Mists", cost: 10, restriction: "SPIRITSEER model only.", text: "" },
                    { name: "Higher Duty", cost: 25, restriction: "SPIRITSEER model only.", text: "" },
                ],
                stratagems: [
                    { name: "Seer's Eye", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Wraithbone Armour", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Blades from Beyond", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Soul Bridge", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Spirit Token", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Crushing Strides", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Craftworld's Champion", cost: 25, restriction: "ASURYANI model only.", text: "" },
                    { name: "Ethereal Pathway", cost: 30, restriction: "ASURYANI model only.", text: "" },
                    { name: "Protector of the Paths", cost: 20, restriction: "ASURYANI model only.", text: "" },
                    { name: "Breath of Vaul", cost: 10, restriction: "ASURYANI model only.", text: "" },
                ],
                stratagems: [
                    { name: "Warding Salvoes", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Shield Nodes", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Vaul's Vengeance", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Time to Strike", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Blades of Asuryan", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Cost of Victory", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Cegorach's Coil", cost: 25, restriction: "TROUPE MASTER model only.", text: "" },
                    { name: "Mask of Secrets", cost: 15, restriction: "HARLEQUINS model only.", text: "" },
                    { name: "Murder's Jest", cost: 20, restriction: "DEATH JESTER model only.", text: "" },
                    { name: "Mistweave", cost: 15, restriction: "SHADOWSEER model only.", text: "" },
                ],
                stratagems: [
                    { name: "Staged Death", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Heroes' Fall", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Mocking Flight", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Tricksters' Retort", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Bloody Dance", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Exit the Stage", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Gaze of Ynnead", cost: 15, restriction: "FARSEER model only.", text: "" },
                    { name: "Storm of Whispers", cost: 10, restriction: "WARLOCK model only.", text: "" },
                    { name: "Borrowed Vigour", cost: 10, restriction: "ARCHON model only.", text: "" },
                    { name: "Morbid Might", cost: 15, restriction: "SUCCUBUS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Pall of Dread", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Macabre Resilience", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Emissaries of Ynnead", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Parting the Veil", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Soulsight", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Death Answers Death", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                name: "Seer Council",
                ...
                enhancements: [
                    { name: "Lucid Eye", cost: 30, restriction: "ASURYANI PSYKER model only.", text: "" },
                    { name: "Runes of Warding", cost: 25, restriction: "ASURYANI PSYKER model only.", text: "" },
                    { name: "Stone of Eldritch Fury", cost: 15, restriction: "ASURYANI PSYKER model only.", text: "" },
                    { name: "Torc of Morai-Heg", cost: 20, restriction: "ASURYANI PSYKER model only.", text: "" },
                ],
                stratagems: [
                    { name: "Presentiment of Dread", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Forewarned", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Unshrouded Truth", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Fate Inescapable", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Isha's Fury", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Psychic Shield", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                name: "Aspect Host",
                ...
                enhancements: [
                    { name: "Aspect of Murder", cost: 25, restriction: "AUTARCH or AUTARCH WAYLEAPER model only.", text: "" },
                    { name: "Mantle of Wisdom", cost: 30, restriction: "AUTARCH or AUTARCH WAYLEAPER model only.", text: "" },
                    { name: "Shimmerstone", cost: 15, restriction: "AUTARCH or AUTARCH WAYLEAPER model only.", text: "" },
                    { name: "Strategic Savant", cost: 15, restriction: "AUTARCH or AUTARCH WAYLEAPER model only.", text: "" },
                ],
                stratagems: [
                    { name: "Warrior Focus", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "To Their Final Breath", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Skyborne Sanctuary", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Doom Inescapable", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Preternatural Precision", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Khaine's Vengeance", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Guiding Presence", cost: 25, restriction: "AELDARI PSYKER model only.", text: "" },
                    { name: "Harmonisation Matrix", cost: 30, restriction: "AELDARI model only.", text: "" },
                    { name: "Spirit Stone of Raelyth", cost: 20, restriction: "AELDARI PSYKER model only.", text: "" },
                    { name: "Guileful Strategist", cost: 15, restriction: "AELDARI model only.", text: "" },
                ],
                stratagems: [
                    { name: "Layered Wards", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Swift Deployment", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Vectored Engines", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Cloudstrike", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Soulsight", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Anti-grav Repulsion", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Key of Ghosts", cost: 20, text: "" },
                    { name: "Weavers' Wail", cost: 20, restriction: "TROUPE MASTER model only.", text: "" },
                    { name: "Fanged Leer", cost: 10, restriction: "DEATH JESTER model only.", text: "" },
                    { name: "Shedskin Raiment", cost: 25, restriction: "SHADOWSEER model only.", text: "" },
                ],
                stratagems: [
                    { name: "Fangs of the Brood", cp: 1, type: "", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Venomous Wrath", cp: 1, type: "", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Striking Stride", cp: 1, type: "", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Weavers' Coils", cp: 1, type: "", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Weaving Stride", cp: 1, type: "", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Skyward Lunge", cp: 1, type: "", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Pirate Prince", cost: 15, restriction: "PRINCE YRIEL unit only.", text: "" },
                    { name: "Alacritous Assault", cost: 20, restriction: "ANHRATHE unit only.", text: "" },
                    { name: "Exotic Munitions", cost: 15, restriction: "ANHRATHE unit only.", text: "" },
                    { name: "Adrenal Infusions", cost: 20, restriction: "ANHRATHE INFANTRY unit only.", text: "" },
                ],
                stratagems: [
                    { name: "Raiders' Spoils", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Ruthless Killers", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Yriel's Example", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "No Prey Too Big", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Impeding Fire", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Withdraw and Reinforce", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Infamy (Aura)", cost: 25, restriction: "ANHRATHE unit only.", text: "" },
                    { name: "Webway Pathstone", cost: 25, restriction: "ANHRATHE unit only.", text: "" },
                    { name: "Archraider", cost: 35, restriction: "ANHRATHE CHARACTER unit only.", text: "" },
                    { name: "Voidstone", cost: 15, restriction: "ANHRATHE INFANTRY unit only.", text: "" },
                ],
                stratagems: [
                    { name: "Pirates' Due", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Lethal Ruse", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Outcast Ambush", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Into the Breach", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Cloak and Shadow", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Vengeful Sorrow", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            }
        ],
        units: [
