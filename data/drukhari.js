        ...
        detachments: [
            {
                ...
                enhancements: [
                    { name: "Dark Vitality", cost: 25, restriction: "DRUKHARI model only.", text: "" },
                    { name: "Labyrinthine Cunning", cost: 25, restriction: "ARCHON model only.", text: "" },
                    { name: "Eye of Spite", cost: 15, restriction: "SUCCUBUS model only.", text: "" },
                    { name: "Crucible of Malediction", cost: 20, restriction: "HAEMONCULUS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Insensible to Pain", cp: 2, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Fighting Shadows", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Instinctive Spite", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Dark Harvest", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Eager for the Kill", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Raid and Fade", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Phantasmal Smoke", cost: 15, restriction: "DRUKHARI model only.", text: "" },
                    { name: "Sadistic Fulcrum", cost: 15, restriction: "DRUKHARI model only.", text: "" },
                    { name: "Spiteful Raider", cost: 10, restriction: "DRUKHARI model only.", text: "" },
                    { name: "Nightmare Shroud", cost: 20, restriction: "DRUKHARI model only.", text: "" },
                ],
                stratagems: [
                    { name: "Vicious Blades", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Wraithlike Retreat", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Pounce on the Prey", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Skyborne Annihilation", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Swooping Mockery", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Night Shield", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Pharmacophex", cost: 15, restriction: "SUCCUBUS model only.", text: "" },
                    { name: "Chronoshard", cost: 15, restriction: "SUCCUBUS model only.", text: "" },
                    { name: "Periapt of Torments", cost: 25, restriction: "SUCCUBUS model only.", text: "" },
                    { name: "Morghenna's Curse", cost: 20, restriction: "SUCCUBUS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Berserk Fugue", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Deadly Debut", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Feigned Weakness", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Preternatural Agility", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "A Challenge Met", cp: 2, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Acrobatic Display", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Master Regenesist", cost: 25, restriction: "HAEMONCULUS model only.", text: "" },
                    { name: "Master Nemesine", cost: 5, restriction: "HAEMONCULUS model only.", text: "" },
                    { name: "Master Artisan", cost: 20, restriction: "HAEMONCULUS model only.", text: "" },
                    { name: "Master Repugnomancer (Aura)", cost: 15, restriction: "HAEMONCULUS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Postmortality", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Symphony of Suffering", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Poisoner's Art", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Distillers of Fear", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Connoisseurs of Pain", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Enfolding Nightmare", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Leechbite Plate", cost: 5, restriction: "ARCHON model only.", text: "" },
                    { name: "Webway Awl", cost: 25, restriction: "ARCHON model only.", text: "" },
                    { name: "Informant Network", cost: 30, restriction: "ARCHON model only.", text: "" },
                    { name: "Towering Arrogance", cost: 20, restriction: "ARCHON model only.", text: "" },
                ],
                stratagems: [
                    { name: "Double-cross", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Taken Alive", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Tailored Toxins", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Enemies Without Number", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Making a Point", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Deadly Deceivers", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                name: "Reaper's Wager",
                ...
                enhancements: [
                    { name: "Archraider", cost: 15, restriction: "HARLEQUINS or DRUKHARI model only.", text: "" },
                    { name: "Webway Walker", cost: 15, restriction: "HARLEQUINS or DRUKHARI model only.", text: "" },
                    { name: "Reaper's Cowl", cost: 25, restriction: "HARLEQUINS model only.", text: "" },
                    { name: "Conductor of Torment", cost: 20, restriction: "DRUKHARI model only.", text: "" },
                ],
                stratagems: [
                    { name: "Malicious Frenzy", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Fateful Role", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Murderer's Circus", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Shorten the Odds", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Scintillating Tempo", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Dance Macabre", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            }
        ],
        units: [
