    ...
    const whiteScars = {
        ...
        detachments: [
            ...
            },
            {
                ...
                enhancements: [
                    { name: "Spearpoint Paragon", cost: 25, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Stormseers' Wisdom", cost: 15, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Hunter's Eye", cost: 20, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Chogorian Huntmaster", cost: 25, restriction: "ADEPTUS ASTARTES MOUNTED model only." },
                ],
                stratagems: [
                    { name: "Armour of Contempt", cp: 1, type: "Battle Tactic" },
                    { name: "Spear Thrust and Sabre Swing", cp: 1, type: "Battle Tactic" },
                    { name: "Mobile Lethality", cp: 1, type: "Battle Tactic" },
                    { name: "Hunter's Instincts", cp: 1, type: "Strategic Ploy" },
                    { name: "Evasive Manoeuvres", cp: 1, type: "Battle Tactic" },
                    { name: "Withdraw and Regroup", cp: 1, type: "Strategic Ploy" },
                ]
            }
        ],
