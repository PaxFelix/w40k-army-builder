        ...
        detachments: [
            {
                ...
                enhancements: [
                    { name: "Radial Suffusion", cost: 25, restriction: "ADEPTUS MECHANICUS model only.", text: "" },
                    { name: "Malphonic Susurrus", cost: 20, restriction: "ADEPTUS MECHANICUS model only.", text: "" },
                    { name: "Peerless Eradicator", cost: 20, restriction: "ADEPTUS MECHANICUS model only.", text: "" },
                    { name: "Autoclavic Denunciation", cost: 15, restriction: "ADEPTUS MECHANICUS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Baleful Halo", cp: 2, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Extinction Order", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Aggressor Imperative", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Pre-calibrated Purge Solution", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Lethal Dosage", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Bulwark Imperative", cp: 2, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Cantic Thrallnet", cost: 25, restriction: "SKITARII MARSHAL model only.", text: "" },
                    { name: "Clandestine Infiltrator", cost: 20, restriction: "SKITARII model only.", text: "" },
                    { name: "Veiled Hunter", cost: 10, restriction: "SKITARII MARSHAL model only.", text: "" },
                    { name: "Battle-sphere Uplink", cost: 30, restriction: "SKITARII model only.", text: "" },
                ],
                stratagems: [
                    { name: "Bionic Endurance", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Binharic Offence", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Expedited Purge Protocol", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Isolate and Destroy", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Shroud Protocols", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Programmed Withdrawal", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Mechanicus Locum", cost: 10, restriction: "TECH-PRIEST model only.", text: "" },
                    { name: "Mantle of the Gnosticarch", cost: 15, restriction: "TECH-PRIEST model only.", text: "" },
                    { name: "Data-blessed Autosermon", cost: 20, restriction: "TECH-PRIEST model only.", text: "" },
                    { name: "Temporcopia", cost: 25, restriction: "TECH-PRIEST model only.", text: "" },
                ],
                stratagems: [
                    { name: "Incantation of the Iron Soul", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Chant of the Remorseless Fist", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Verse of Vengeance", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Tribute of Emphatic Veneration", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Litany of the Electromancer", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Luminescent Blessing", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Magos", cost: 15, restriction: "TECH-PRIEST model only.", text: "" },
                    { name: "Genetor", cost: 25, restriction: "TECH-PRIEST model only.", text: "" },
                    { name: "Logis", cost: 20, restriction: "TECH-PRIEST model only.", text: "" },
                    { name: "Artisan", cost: 15, restriction: "TECH-PRIEST model only.", text: "" },
                ],
                stratagems: [
                    { name: "Cached Acquisition", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Priority Reclamation", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Infoslave Skull", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Auto-oracular Retrieval", cp: 2, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Incense Exhausts", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Reactive Safeguard", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Necromechanic", cost: 25, restriction: "TECH-PRIEST model only.", text: "" },
                    { name: "Lord of Machines", cost: 20, restriction: "TECH-PRIEST model only.", text: "" },
                    { name: "Emotionless Clarity", cost: 15, restriction: "TECH-PRIEST model only.", text: "" },
                    { name: "Arch-negator", cost: 10, restriction: "TECH-PRIEST model only.", text: "" },
                ],
                stratagems: [
                    { name: "Motive Imperative", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Auto-divinatory Targeting", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Machine Spirit Resurgent", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Machine Superiority", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Transcendent Cogitation", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Benevolence of the Omnissiah", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Omnicogitator", cost: 25, restriction: "SKITARII MARSHAL model only.", text: "" },
                    { name: "Martial Signatum Amplificator", cost: 15, restriction: "TECH-PRIEST model only.", text: "" },
                    { name: "Belicosa-Class Capacitor Vanes", cost: 30, restriction: "ADEPTUS MECHANICUS model only.", text: "" },
                    { name: "Omnissiah's Fury", cost: 10, restriction: "SKITARII MARSHAL model only.", text: "" },
                ],
                stratagems: [
                    { name: "Servo-Driven Charge", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Unrelenting Aggression", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Unshackled Wrath", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Threat-Cogitation Targeters", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Precision Onslaught", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Analytic Reprisals", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Transoracular Dyad Wafers", cost: 15, restriction: "CYBERNETICA DATASMITH model only.", text: "" },
                    { name: "Cognitive Reinforcement", cost: 35, text: "" },
                    { name: "Sanctified Ordnance", cost: 10, restriction: "ADEPTUS MECHANICUS model only.", text: "" },
                    { name: "Inloaded Lethality", cost: 15, restriction: "TECH-PRIEST DOMINUS or TECH-PRIEST MANIPULUS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Eradication Protocols", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Targeting Override", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Neural Overload", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Aggressive Impulse", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Guided Retreat", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Analytical Divination", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            }
        ],
        units: [
