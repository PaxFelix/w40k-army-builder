        ...
        detachments: [
            {
                ...
                enhancements: [
                    { name: "Exemplar of the Kauyon", cost: 20, text: "" },
                    { name: "Precision of the Patient Hunter", cost: 15, restriction: "T'AU EMPIRE model only.", text: "" },
                    { name: "Solid-image Projection Unit", cost: 30, restriction: "T'AU EMPIRE model only.", text: "" },
                    { name: "Through Unity, Devastation", cost: 40, text: "" },
                ],
                stratagems: [
                    { name: "A Tempting Trap", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Point-blank Ambush", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Coordinate to Engage", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Combat Embarkation", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Photon Grenades", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Wall of Mirrors", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                name: "Mont'ka",
                ...
                enhancements: [
                    { name: "Coordinated Exploitation", cost: 40, text: "" },
                    { name: "Exemplar of the Mont'ka", cost: 10, text: "" },
                    { name: "Strategic Conqueror", cost: 15, restriction: "T'AU EMPIRE model only.", text: "" },
                    { name: "Strike Swiftly", cost: 25, restriction: "T'AU EMPIRE model only.", text: "" },
                ],
                stratagems: [
                    { name: "Pinpoint Counter-offensive", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Aggressive Mobility", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Focused Fire", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Combat Debarkation", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Pulse Onslaught", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Counterfire Defence Systems", cp: 2, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Internal Grenade Racks", cost: 20, restriction: "T'AU EMPIRE BATTLESUIT model only.", text: "" },
                    { name: "Prototype Weapon System", cost: 15, restriction: "T'AU EMPIRE BATTLESUIT model only.", text: "" },
                    { name: "Puretide Engram Neurochip", cost: 25, restriction: "T'AU EMPIRE BATTLESUIT model only.", text: "" },
                    { name: "Starflare Ignition System", cost: 20, restriction: "T'AU EMPIRE BATTLESUIT model only.", text: "" },
                ],
                stratagems: [
                    { name: "Fail-safe Detonator", cp: 2, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Stimm Injectors", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "The Shortened Blade", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "The Arro'kon Protocol", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "The Torchstar Gambit", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Grav-inhibitor Field", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Borthrod Gland", cost: 15, restriction: "Kroot Flesh Shaper only.", text: "" },
                    { name: "Kroothawk Flock", cost: 10, restriction: "KROOT model only.", text: "" },
                    { name: "Nomadic Hunter", cost: 20, restriction: "KROOT TRAIL SHAPER model only.", text: "" },
                    { name: "Root-carved Weapons", cost: 10, restriction: "Kroot War Shaper model only.", text: "" },
                ],
                stratagems: [
                    { name: "Join the Hunt", cp: 2, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "A Trap Well Laid", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Emp Grenades", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "The Grisly Feast", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Guerrilla Warriors", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Hidden Hunters", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Student of Kauyon", cost: 15, restriction: "KROOT SHAPER model only.", text: "" },
                    { name: "Admired Leader", cost: 20, restriction: "T'AU EMPIRE model (excluding KROOT models) only.", text: "" },
                    { name: "Fanatical Convert", cost: 10, restriction: "KROOT model only.", text: "" },
                    { name: "Transponder Lock Module", cost: 25, restriction: "T'AU EMPIRE WALKER model with the Deep Strike ability only.", text: "" },
                ],
                stratagems: [
                    { name: "Experimental Modifications", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Multisensory Scanning", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Interlocking Manouevres", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Pheromone Waypoints", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Alien Expertise", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Guided Fire", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Supernova Launcher", cost: 15, restriction: "T'AU EMPIRE model only.", text: "" },
                    { name: "Thermoneutronic Projector", cost: 20, restriction: "T'AU EMPIRE model only.", text: "" },
                    { name: "Plasma Accelerator Rifle", cost: 10, restriction: "T'AU EMPIRE model only.", text: "" },
                    { name: "Fusion Blades", cost: 25, restriction: "T'AU EMPIRE model only.", text: "" },
                ],
                stratagems: [
                    { name: "Automated Repair Drones", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Reactive Impact Dampeners", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Experimental Weaponry", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Experimental Ammunition", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Threat Assessment Analyser", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Neuroweb System Jammer", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                ]
            }
        ],
        units: [
