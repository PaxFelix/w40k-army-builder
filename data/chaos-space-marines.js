        ...
        detachments: [
            {
                ...
                enhancements: [
                    { name: "Eager for Vengeance", cost: 20, text: "" },
                    { name: "Eye of Abaddon", cost: 15, text: "" },
                    { name: "Mark of Legend", cost: 10, text: "" },
                    { name: "Warmaster's Gift", cost: 15, restriction: "CHAOS LORD model only.", text: "" },
                ],
                stratagems: [
                    { name: "Endless Ire", cp: 2, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Contemptuous Disregard", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Bringers of Despair", cp: 2, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Black Crusade", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Let the Galaxy Burn", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Millennia of Experience", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                name: "Deceptors",
                ...
                enhancements: [
                    { name: "Cursed Fang", cost: 10, restriction: "HERETIC ASTARTES INFANTRY model only.", text: "" },
                    { name: "Falsehood", cost: 10, text: "" },
                    { name: "Shroud of Obfuscation", cost: 15, restriction: "HERETIC ASTARTES INFANTRY model only.", text: "" },
                    { name: "Soul Link", cost: 5, restriction: "HERETIC ASTARTES INFANTRY model only.", text: "" },
                ],
                stratagems: [
                    { name: "Detonator", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "From All Sides", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Pick Them Off", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Coils of Deception", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Relentless Pursuit", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Scrambled Coordinates", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Despot's Claim", cost: 15, restriction: "HERETIC ASTARTES model only.", text: "" },
                    { name: "Dread Reaver", cost: 15, restriction: "HERETIC ASTARTES model only.", text: "" },
                    { name: "Mark of the Hound", cost: 25, restriction: "HERETIC ASTARTES model only.", text: "" },
                    { name: "Tyrant's Lash", cost: 20, restriction: "HERETIC ASTARTES model only.", text: "" },
                ],
                stratagems: [
                    { name: "Unfailingly Obdurate", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Scour and Seize", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Opportunistic Raiders", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Warpcharged Engines", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Ruinous Raid", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Reavers' Haste", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                name: "Dread Talons",
                ...
                enhancements: [
                    { name: "Eater of Dread", cost: 15, restriction: "HERETIC ASTARTES model only.", text: "" },
                    { name: "Night's Shroud", cost: 20, text: "" },
                    { name: "Warp-fuelled Thrusters", cost: 20, restriction: "JUMP PACK CHAOS LORD model only.", text: "" },
                    { name: "Willbreaker", cost: 10, restriction: "HERETIC ASTARTES model only.", text: "" },
                ],
                stratagems: [
                    { name: "Depthless Cruelty", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Bloody Example", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Pitiless Hunters", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Relentless Terror", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Screaming Descent", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Merciless Pursuit", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Bastion Plate", cost: 10, text: "" },
                    { name: "Iron Artifice", cost: 10, restriction: "HERETIC ASTARTES INFANTRY model only.", text: "" },
                    { name: "Ironbound Enmity", cost: 15, restriction: "HERETIC ASTARTES model only.", text: "" },
                    { name: "Warp Tracer", cost: 20, restriction: "HERETIC ASTARTES model only.", text: "" },
                ],
                stratagems: [
                    { name: "Persistent Assailants", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Brutal Attrition", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Pitiless Cannonade", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Point-blank Destruction", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Steadfast Determination", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Siegecraft", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Eye of Tzeentch", cost: 15, restriction: "HERETIC ASTARTES TZEENTCH model only.", text: "" },
                    { name: "Intoxicating Elixir", cost: 15, restriction: "HERETIC ASTARTES SLAANESH model only.", text: "" },
                    { name: "Orbs of Unlife", cost: 15, restriction: "HERETIC ASTARTES NURGLE model only.", text: "" },
                    { name: "Talisman of Burning Blood", cost: 15, restriction: "HERETIC ASTARTES KHORNE model only.", text: "" },
                ],
                stratagems: [
                    { name: "Eye of the Gods", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Eternal Hate", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Profane Zeal", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Skinshift", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Torpefying Refrain", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Festering Miasma", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                name: "Chaos Cult",
                ...
                enhancements: [
                    { name: "Amulet of Tainted Vigour", cost: 20, restriction: "DARK APOSTLE model only.", text: "" },
                    { name: "Cultist's Brand", cost: 20, restriction: "DARK APOSTLE or DAMNED model only.", text: "" },
                    { name: "Incendiary Goad", cost: 15, restriction: "DARK APOSTLE or DAMNED model only.", text: "" },
                    { name: "Warped Foresight", cost: 10, restriction: "DARK APOSTLE or DAMNED model only.", text: "" },
                ],
                stratagems: [
                    { name: "Chosen for Glory", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Selfless Demise", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Infernal Sacrifice", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Crazed Focus", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Reckless Haste", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Mortal Thralls", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Forge's Blessing", cost: 20, restriction: "HERETIC ASTARTES model only.", text: "" },
                    { name: "Invigorated Mechatendrils", cost: 15, restriction: "WARPSMITH model only.", text: "" },
                    { name: "Tempting Addendum", cost: 25, restriction: "HERETIC ASTARTES model only.", text: "" },
                    { name: "Soul Harvester", cost: 15, restriction: "HERETIC ASTARTES model only.", text: "" },
                ],
                stratagems: [
                    { name: "Desperate Pledge", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Glut of Souls", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Daemonic Possession", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Unstoppable Rampage", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Predatory Pursuit", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Feeding Frenzy", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                name: "Cabal of Chaos",
                ...
                enhancements: [
                    { name: "Touched by the Warp", cost: 10, text: "" },
                    { name: "Eyes of Z'desh", cost: 25, restriction: "HERETIC ASTARTES model only.", text: "" },
                    { name: "Mind Blade", cost: 25, restriction: "PSYKER model only.", text: "" },
                    { name: "Infernal Avatar", cost: 20, text: "" },
                ],
                stratagems: [
                    { name: "Baleful Blessing", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "No Rest in Death", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Mutation's Curse", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Soulseekers", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Unholy Haste", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Shroud of Chaos", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Surgical Precision", cost: 10, restriction: "HERETIC ASTARTES model (excluding DAMNED models) only.", text: "" },
                    { name: "Living Carapace", cost: 15, restriction: "CHAOS LORD model only.", text: "" },
                    { name: "Helm of All-seeing", cost: 25, restriction: "HERETIC ASTARTES INFANTRY model (excluding DAMNED models) only.", text: "" },
                    { name: "Prime Test Subject", cost: 35, restriction: "HERETIC ASTARTES INFANTRY model (excluding DAMNED models) only.", text: "" },
                ],
                stratagems: [
                    { name: "Monstrous Visages", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Masters Are Watching", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Specimens for the Spider", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Delayed Mutations", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Diabolic Regeneration", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Autostimulants", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                name: "Nightmare Hunt",
                ...
                enhancements: [
                    { name: "Greyveil Hex", cost: 25, restriction: "CHAOS LORD model only.", text: "" },
                    { name: "Warp-fuelled Thrusters", cost: 20, restriction: "CHAOS LORD JUMP PACK model only.", text: "" },
                    { name: "Terrorglut Parasite", cost: 20, restriction: "HERETIC ASTARTES model only.", text: "" },
                    { name: "Sorrowscent Vulture", cost: 35, restriction: "CHAOS LORD JUMP PACK model only.", text: "" },
                ],
                stratagems: [
                    { name: "Talons Sunk Deep", cp: 1, type: "", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Prey on the Weak", cp: 1, type: "", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Sadistic Display", cp: 1, type: "", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Malicious Surge", cp: 1, type: "", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Relentless Terror", cp: 1, type: "", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Horrific Incursion", cp: 1, type: "", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Voice of the Tyrant", cost: 25, text: "" },
                    { name: "Raid Leader", cost: 20, text: "" },
                    { name: "Dread Reputation", cost: 25, text: "" },
                    { name: "Eager for Bloodshed", cost: 30, restriction: "HERETIC ASTARTES model only.", text: "" },
                ],
                stratagems: [
                    { name: "Hardened Killers", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "At the Tyrant's Command", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Seize the Prize", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Reavers' Flurry", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "To the Favoured the Spoils", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Encircling Surge", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Weaponised Hatred", cost: 35, restriction: "HERETIC ASTARTES model only.", text: "" },
                    { name: "Eyes of the Hunter", cost: 15, restriction: "HERETIC ASTARTES model only.", text: "" },
                    { name: "Fratricidal Trophies", cost: 5, restriction: "HERETIC ASTARTES TERMINATOR model only.", text: "" },
                    { name: "Empyric Symbiote", cost: 15, restriction: "HERETIC ASTARTES model only.", text: "" },
                ],
                stratagems: [
                    { name: "Never Outgunned", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Vengeful Destruction", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Undying Hatred", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Renegade Claim", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Corrupted Munitions", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Reavers' Reaction", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Infernal Fulgurite", cost: 20, text: "" },
                    { name: "Eye of the Warp", cost: 15, restriction: "HERETIC ASTARTES model with the Deep Strike ability only.", text: "" },
                    { name: "Akshur's Binding Runes", cost: 20, restriction: "HERETIC ASTARTES model with the Deep Strike ability only.", text: "" },
                    { name: "Tzagulla", cost: 25, restriction: "HERETIC ASTARTES model with the Deep Strike ability only.", text: "" },
                ],
                stratagems: [
                    { name: "Empyric Dislocation", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Armour of Corruption", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Warp Flicker", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Warp-tainted", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Siegebreaker Strike", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Portal of Spite", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Wyredjinn", cost: 25, text: "" },
                    { name: "Cybinfernal Font", cost: 20, text: "" },
                    { name: "Mark of the Soul Forges", cost: 20, text: "" },
                    { name: "Crown of Worms", cost: 15, restriction: "WARPSMITH model only.", text: "" },
                ],
                stratagems: [
                    { name: "Touch of the Arkifane", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Balefire Boon", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Soul-tally Offering", cp: 2, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Biomechanoid Regeneration", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Forge-fire Surge", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Unholy Fortitude", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            }
        ],
        units: [
