        ...
        detachments: [
            {
                ...
                enhancements: [
                    { name: "Follow Me Ladz", cost: 25, restriction: "ORKS model only." },
                    { name: "Headwoppa's Killchoppa", cost: 20, restriction: "ORKS model only." },
                    { name: "Kunnin' But Brutal", cost: 15, restriction: "ORKS model only." },
                    { name: "Supa-Cybork Body", cost: 15, restriction: "ORKS model only." },
                ],
                stratagems: [
                    { name: "Careen!", cp: 1, type: "Epic Deed" },
                    { name: "Orks Is Never Beaten", cp: 2, type: "Epic Deed" },
                    { name: "Unbridled Carnage", cp: 1, type: "Battle Tactic" },
                    { name: "'ard As Nails", cp: 1, type: "Battle Tactic" },
                    { name: "Mob Rule", cp: 1, type: "Battle Tactic" },
                    { name: "Ere We Go", cp: 1, type: "Battle Tactic" },
                ]
            },
            {
                name: "Da Big Hunt",
                ...
                enhancements: [
                    { name: "Glory Hog", cost: 30, restriction: "BEASTBOSS ON SQUIGOSAUR model only." },
                    { name: "Proper Killy", cost: 15, restriction: "BEAST SNAGGA model only." },
                    { name: "Skrag Every Stash!", cost: 25, restriction: "BEAST SNAGGA model only." },
                    { name: "Surly as a Squiggoth", cost: 20, restriction: "BEASTBOSS ON SQUIGOSAUR model only." },
                ],
                stratagems: [
                    { name: "Drag It Down", cp: 1, type: "Battle Tactic" },
                    { name: "Unstoppable Momentum", cp: 1, type: "Strategic Ploy" },
                    { name: "Dat One's Even Bigga!", cp: 1, type: "Strategic Ploy" },
                    { name: "Where D'ya Fink You're Going?", cp: 1, type: "Strategic Ploy" },
                    { name: "Stalkin' Taktiks", cp: 1, type: "Battle Tactic" },
                    { name: "Instinctive Hunters", cp: 1, type: "Strategic Ploy" },
                ]
            },
            {
                name: "Kult of Speed",
                ...
                enhancements: [
                    { name: "Fasta Than Yooz", cost: 35, restriction: "ORKS INFANTRY model only." },
                    { name: "Speed Makes Right", cost: 25, restriction: "ORKS model only." },
                    { name: "Squig-hide Tyres", cost: 15, restriction: "DEFFKILLA WARTRIKE model only." },
                    { name: "Wazblasta", cost: 10, restriction: "DEFFKILLA WARTRIKE model only." },
                ],
                stratagems: [
                    { name: "Speediest Freeks", cp: 1, type: "Strategic Ploy" },
                    { name: "Squig Flingin'", cp: 1, type: "Strategic Ploy" },
                    { name: "Dakkastorm", cp: 1, type: "Battle Tactic" },
                    { name: "Blitza Fire", cp: 1, type: "Battle Tactic" },
                    { name: "Full Throttle!", cp: 1, type: "Battle Tactic" },
                    { name: "More Gitz Over 'ere!", cp: 1, type: "Strategic Ploy" },
                ]
            },
            {
                name: "Dread Mob",
                ...
                enhancements: [
                    { name: "Gitfinder Googlez", cost: 10, restriction: "MEK model only." },
                    { name: "Press It Fasta!", cost: 35, restriction: "MEK model only." },
                    { name: "Smoky Gubbinz", cost: 15, restriction: "MEK model only." },
                    { name: "Supa-glowy Fing", cost: 20, restriction: "MEK model only." },
                ],
                stratagems: [
                    { name: "Klankin' Klaws", cp: 1, type: "Battle Tactic" },
                    { name: "Superfuelled Boiler", cp: 1, type: "Strategic Ploy" },
                    { name: "Bigger Shells for Bigger Gitz", cp: 1, type: "Battle Tactic" },
                    { name: "Dakka! Dakka! Dakka!", cp: 1, type: "Battle Tactic" },
                    { name: "Conniving Runts", cp: 1, type: "Strategic Ploy" },
                    { name: "Extra Gubbinz", cp: 1, type: "Battle Tactic" },
                ]
            },
            {
                name: "Green Tide",
                ...
                enhancements: [
                    { name: "Bloodthirsty Belligerence", cost: 15, restriction: "ORKS INFANTRY model only." },
                    { name: "Brutal But Kunnin'", cost: 25, restriction: "ORKS INFANTRY model only." },
                    { name: "Ferocious Show Off", cost: 10, restriction: "ORKS INFANTRY model only." },
                    { name: "Raucous Warcaller", cost: 20, restriction: "ORKS INFANTRY model only." },
                ],
                stratagems: [
                    { name: "Competitive Streak", cp: 1, type: "Battle Tactic" },
                    { name: "Bulldozer Brutality", cp: 1, type: "Battle Tactic" },
                    { name: "Braggin' Rights", cp: 1, type: "Strategic Ploy" },
                    { name: "Come on Ladz!", cp: 1, type: "Strategic Ploy" },
                    { name: "Tide of Muscle", cp: 1, type: "Epic Deed" },
                    { name: "Go Get 'em!", cp: 1, type: "Strategic Ploy" },
                ]
            },
            {
                name: "Bully Boyz",
                ...
                enhancements: [
                    { name: "Big Gob", cost: 20, restriction: "INFANTRY WARBOSS model only." },
                    { name: "Da Biggest Boss", cost: 15, restriction: "INFANTRY WARBOSS model only." },
                    { name: "'Eadstompa", cost: 10, restriction: "INFANTRY WARBOSS model only." },
                    { name: "Tellyporta", cost: 25, restriction: "WARBOSS IN MEGA ARMOUR model only." },
                ],
                stratagems: [
                    { name: "Armed to Dateef", cp: 1, type: "Battle Tactic" },
                    { name: "Too Arrogant to Die", cp: 1, type: "Strategic Ploy" },
                    { name: "Always Lookin' Fer a Fight", cp: 1, type: "Strategic Ploy" },
                    { name: "Crushing Impact", cp: 1, type: "Epic Deed" },
                    { name: "Cut'em Down", cp: 1, type: "Battle Tactic" },
                    { name: "Hulking Brutes", cp: 1, type: "Battle Tactic" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Skwad Leader", cost: 15, restriction: "WARBOSS INFANTRY model only." },
                    { name: "Mek Kaptin", cost: 45 },
                    { name: "Mork's Kunnin'", cost: 15, restriction: "ORKS model only." },
                    { name: "Gob Boomer", cost: 10, restriction: "WARBOSS or MEK model only." },
                ],
                stratagems: [
                    { name: "Dat's Ours", cp: 1, type: "Strategic Ploy" },
                    { name: "Fight Proppa", cp: 1, type: "Battle Tactic" },
                    { name: "Taktikal Retreat", cp: 1, type: "Strategic Ploy" },
                    { name: "Krunchin' Descent", cp: 1, type: "Battle Tactic" },
                    { name: "On to Da Next", cp: 1, type: "Strategic Ploy" },
                    { name: "Ded Sneaky", cp: 1, type: "Strategic Ploy" },
                ]
            },
            {
                name: "More Dakka!",
                ...
                enhancements: [
                    { name: "Da Gobshot Thunderbuss", cost: 15, restriction: "ORKS model only." },
                    { name: "Dead Shiny Shootas", cost: 35, restriction: "ORKS model only." },
                    { name: "Targetin' Squigs", cost: 15, restriction: "ORKS model only." },
                    { name: "Zog Off and Eat Dakka!", cost: 10, restriction: "ORKS model only." },
                ],
                stratagems: [
                    { name: "Orks Is Still Orks", cp: 1, type: "Battle Tactic" },
                    { name: "Get Stuck in, Ladz!", cp: 2, type: "Epic Deed" },
                    { name: "Huge Show-offs", cp: 1, type: "Epic Deed" },
                    { name: "Long, Uncontrolled Bursts", cp: 1, type: "Battle Tactic" },
                    { name: "Speshul Shells", cp: 1, type: "Wargear" },
                    { name: "Call Dat Dakka?", cp: 1, type: "Strategic Ploy" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Da Kaptin", cost: 10, restriction: "WARBOSS model only." },
                    { name: "Git-spotter Squig", cost: 20, restriction: "ORKS model only." },
                    { name: "Bionik Workshop", cost: 15, restriction: "BIG MEK or PAINBOY model only." },
                    { name: "Razgit's Magik Map", cost: 25, restriction: "ORKS model only." },
                ],
                stratagems: [
                    { name: "Bash and Grab", cp: 1, type: "Battle Tactic" },
                    { name: "Grab and Bash", cp: 1, type: "Strategic Ploy" },
                    { name: "Boardin' Rush", cp: 1, type: "Battle Tactic" },
                    { name: "Deck Fraggers", cp: 1, type: "Strategic Ploy" },
                    { name: "Rolling Loot-heap", cp: 1, type: "Strategic Ploy" },
                    { name: "Krump and Run", cp: 1, type: "Strategic Ploy" },
                ]
            },
            {
                name: "Speedwaaagh!",
                ...
                enhancements: [
                    { name: "Kustom Shokk Box", cost: 10, restriction: "DEFFKILLA WARTRIKE model only." },
                    { name: "Dakkamek", cost: 25, restriction: "MEK model only." },
                    { name: "Supa-burny Fuel", cost: 15, restriction: "DEFFKILLA WARTRIKE model only." },
                    { name: "Master Meknologist", cost: 20, restriction: "BIG MEK model only." },
                ],
                stratagems: [
                    { name: "On Da Move", cp: 1, type: "Strategic Ploy" },
                    { name: "Mobile Dakkastorm", cp: 1, type: "Strategic Ploy" },
                    { name: "Speshul Ammo", cp: 1, type: "Wargear" },
                    { name: "Ded Killy Construction", cp: 1, type: "Strategic Ploy" },
                    { name: "Dust Trails", cp: 1, type: "Strategic Ploy" },
                    { name: "Evasive Manoova", cp: 1, type: "Strategic Ploy" },
                ]
            },
            {
                name: "Blitz Brigade",
                ...
                enhancements: [
                    { name: "Runnin' Boots", cost: 10, restriction: "ORKS INFANTRY CHARACTER model only." },
                    { name: "Blitzkaptin", cost: 25, restriction: "ORKS CHARACTER model only." },
                    { name: "Supercharged Squig Oil", cost: 10, restriction: "MEK model only." },
                    { name: "Tuff Git", cost: 5, restriction: "ORKS INFANTRY CHARACTER model only." },
                ],
                stratagems: [
                    { name: "Mount Up, Ladz", cp: 1, type: "Strategic Ploy" },
                    { name: "Mekanised Brutality", cp: 1, type: "Strategic Ploy" },
                    { name: "Run 'em Down", cp: 1, type: "Strategic Ploy" },
                    { name: "Armoured Duellists", cp: 1, type: "Battle Tactic" },
                    { name: "Impervious", cp: 1, type: "Strategic Ploy" },
                    { name: "Yooz in Trouble Now", cp: 1, type: "Strategic Ploy" },
                ]
            }
        ],
