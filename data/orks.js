...
(function () {
    ...
    const orks = {
        ...
        detachments: [
            { name: "War Horde", flavour: "", rule: { name: "Get Stuck In", flavour: "", text: "", restrictions: "" }, enhancements: [], stratagems: [] },
            { name: "Da Big Hunt", flavour: "", rule: { name: "Da Hunt Is On", flavour: "", text: "", restrictions: "" }, enhancements: [], stratagems: [] },
            { name: "Kult of Speed", flavour: "", rule: { name: "Adrenaline Junkies", flavour: "", text: "", restrictions: "" }, enhancements: [], stratagems: [] },
            { name: "Dread Mob", flavour: "", rule: { name: "Try Dat Button!", flavour: "", text: "", restrictions: "" }, enhancements: [], stratagems: [] },
            { name: "Green Tide", flavour: "", rule: { name: "Mob Mentality", flavour: "", text: "", restrictions: "" }, enhancements: [], stratagems: [] },
            { name: "Bully Boyz", flavour: "", rule: { name: "Da Boss Is Watchin'", flavour: "", text: "", restrictions: "" }, enhancements: [], stratagems: [] },
            { name: "Taktikal Brigade", flavour: "", rule: { name: "Lissen 'Ere", flavour: "", text: "", restrictions: "" }, enhancements: [], stratagems: [] },
            { name: "More Dakka!", flavour: "", rule: { name: "Dakka! Dakka! Dakka!", flavour: "", text: "", restrictions: "" }, enhancements: [], stratagems: [] },
            { name: "Freebooter Krew", flavour: "", rule: { name: "Here Be Loot", flavour: "", text: "", restrictions: "" }, enhancements: [], stratagems: [] },
            { name: "Speedwaaagh!", flavour: "", rule: { name: "Turbo Boostas", flavour: "", text: "", restrictions: "" }, enhancements: [], stratagems: [] },
            { name: "Blitz Brigade", flavour: "", rule: { name: "Eager for the Fight", flavour: "", text: "", restrictions: "" }, enhancements: [], stratagems: [] }
        ],
