        ...
        detachments: [
            {
                ...
                enhancements: [
                    { name: "Daemon Weapon of Nurgle", cost: 10, restriction: "DEATH GUARD model only.", text: "" },
                    { name: "Furnace of Plagues", cost: 25, restriction: "DEATH GUARD model only.", text: "" },
                    { name: "Arch Contaminator", cost: 25, restriction: "DEATH GUARD model only.", text: "" },
                    { name: "Revolting Regeneration", cost: 20, restriction: "DEATH GUARD model only.", text: "" },
                ],
                stratagems: [
                    { name: "Putrid Detonation", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Disgustingly Resilient", cp: 2, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Plaguesurge", cp: 2, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Leechspore Eruption", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Overwhelming Generosity", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Creeping Blight", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Eye of Affliction", cost: 20, restriction: "DEATH GUARD model only.", text: "" },
                    { name: "Bilemaw Blight", cost: 10, restriction: "MALIGNANT PLAGUECASTER only.", text: "" },
                    { name: "Shriekworm Familiar", cost: 15, restriction: "DEATH GUARD model only.", text: "" },
                    { name: "Tendrilous Emissions", cost: 30, restriction: "LORD OF VIRULENCE only.", text: "" },
                ],
                stratagems: [
                    { name: "Blighted Land", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Relentless Grind", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Drawn to Despair", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Font of Filth", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Eyestinger Storm", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Stinking Mire", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Final Ingredient", cost: 20, restriction: "BIOLOGUS PUTRIFIER only.", text: "" },
                    { name: "Visions of Virulence", cost: 15, restriction: "MALIGNANT PLAGUECASTER only.", text: "" },
                    { name: "Needle of Nurgle", cost: 25, restriction: "PLAGUE SURGEON only.", text: "" },
                    { name: "Cornucophagus", cost: 35, restriction: "LORD OF POXES only.", text: "" },
                ],
                stratagems: [
                    { name: "Blessings of Filth", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Malignance Magnified", cp: 2, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Grotesque Fortitude", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Rabid Infusion", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Mobile Vector", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Death's Heads", cp: 1, type: "Wargear", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Beckoning Blight", cost: 20, restriction: "DEATH GUARD model only.", text: "" },
                    { name: "Fell Harvester", cost: 10, restriction: "DEATH GUARD model only.", text: "" },
                    { name: "Entropic Knell", cost: 15, restriction: "GREAT UNCLEAN ONE only.", text: "" },
                    { name: "Tome of Bounteous Blessings", cost: 20, restriction: "MALIGNANT PLAGUECASTER only.", text: "" },
                ],
                stratagems: [
                    { name: "Persistent Pests", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Clutching Corruption", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "All Is Rot", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Fleshy Avalanche", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Avatars of Decay", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Mireslick", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Witherbone Pipes", cost: 25, restriction: "NOXIOUS BLIGHTBRINGER only.", text: "" },
                    { name: "Lord of the Walking Pox", cost: 15, restriction: "DEATH GUARD model only.", text: "" },
                    { name: "Sorrowsyphon", cost: 10, restriction: "MALIGNANT PLAGUECASTER only.", text: "" },
                    { name: "Talisman of Burgeoning", cost: 25, restriction: "DEATH GUARD model only.", text: "" },
                ],
                stratagems: [
                    { name: "Grip of the Walking Pox", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Smeared with Filth", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Gnawing Hunger", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Hidden Amongst the Dead", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Shock and Horror", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Shambling Wall", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Face of Death", cost: 10, restriction: "TERMINATOR model only.", text: "" },
                    { name: "Vile Vigour", cost: 15, restriction: "TERMINATOR model only.", text: "" },
                    { name: "Warprot Talisman", cost: 30, restriction: "TERMINATOR model only.", text: "" },
                    { name: "Helm of the Fly King", cost: 20, restriction: "TERMINATOR model only.", text: "" },
                ],
                stratagems: [
                    { name: "Blooming Pestilence", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Grim Reapers", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Undying Spite", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Signal Pox", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Mortarion's Teachings", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Sickening Impact", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            }
        ],
        units: [
