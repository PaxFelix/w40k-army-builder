        ...
        detachments: [
            {
                ...
                enhancements: [
                    { name: "Banishing Wave (Psychic)", cost: 20, restriction: "GREY KNIGHTS model only.", text: "" },
                    { name: "Blinding Aura", cost: 10, restriction: "GREY KNIGHTS model only.", text: "" },
                    { name: "Purity of Purpose", cost: 15, restriction: "GREY KNIGHTS model only.", text: "" },
                    { name: "Tome of Forbidden Ways", cost: 25, restriction: "GREY KNIGHTS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Truesilver Channelling", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Combat Manifestation", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Purgation Pattern", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Duty Unending", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Shining Veil", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Expeditious Exit", cp: 2, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Eye of the Augurium", cost: 25, restriction: "GREY KNIGHTS model only.", text: "" },
                    { name: "Inescapable Judgement (Psychic)", cost: 20, restriction: "GREY KNIGHTS model only.", text: "" },
                    { name: "Sanctic Reaper", cost: 15, restriction: "GREY KNIGHTS TERMINATOR model only.", text: "" },
                    { name: "Nemesis Rounds", cost: 10, restriction: "GREY KNIGHTS TERMINATOR model only.", text: "" },
                ],
                stratagems: [
                    { name: "Giants of the Battlefield", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Unending Fidelity", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Point-blank Purgation", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Grind Them Underfoot", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Precognitive Strategies", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Shining Resolve", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                name: "Banishers",
                ...
                enhancements: [
                    { name: "Sigil of the Hunt", cost: 10, restriction: "GREY KNIGHTS model only.", text: "" },
                    { name: "The Ephemeral Tome", cost: 15, restriction: "GREY KNIGHTS INFANTRY model only.", text: "" },
                    { name: "The Sixty-sixth Seal", cost: 25, restriction: "GREY KNIGHTS model only.", text: "" },
                    { name: "Pyresoul (Psychic)", cost: 20, restriction: "GREY KNIGHTS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Hexwrought Reprisal", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Warding Chant", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Chaos Bane", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Celerity", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Circle of Sanctuary", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Shadow of Anarch", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Driven by Duty", cost: 10, restriction: "GREY KNIGHTS WALKER model only.", text: "" },
                    { name: "Quickening Foci", cost: 15, restriction: "GREY KNIGHTS INFANTRY model only.", text: "" },
                    { name: "Sigil of Exigence", cost: 30, restriction: "GREY KNIGHTS model only.", text: "" },
                    { name: "Spiritus Machina", cost: 25, restriction: "GREY KNIGHTS INFANTRY model only.", text: "" },
                ],
                stratagems: [
                    { name: "Truesilver Will", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Abominus-class Targets", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Armoured Aegis", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Redoubled Assault", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Force Wave", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Argent Wrath", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Grimoire of Conjunctions", cost: 10, restriction: "GREY KNIGHTS model only.", text: "" },
                    { name: "Shield of Prophecy", cost: 20, restriction: "GREY KNIGHTS model only.", text: "" },
                    { name: "A Foot in the Future", cost: 15, restriction: "GREY KNIGHTS model only.", text: "" },
                    { name: "Doomseer's Amulet", cost: 25, restriction: "GREY KNIGHTS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Aggressive Anticipation", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Appointed Hour", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Forewarned Evasion", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Necessary End", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Redirected Strike", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Mirage of Echoes", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Mandulian Reliquary", cost: 20, restriction: "GREY KNIGHTS model only.", text: "" },
                    { name: "Radiant Champion", cost: 15, restriction: "GREY KNIGHTS INFANTRY model only.", text: "" },
                    { name: "Phial of the Abyss", cost: 25, restriction: "GREY KNIGHTS INFANTRY model only.", text: "" },
                    { name: "Paragon of Sanctity", cost: 10, restriction: "GREY KNIGHTS model only.", text: "" },
                ],
                stratagems: [
                    { name: "Sanctified Kill Zone", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Flames of Sanctity", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Hallowed Beacon", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Fires of Covenant", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Aegis Eternal", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Repelling Sphere", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                ]
            }
        ],
        units: [
