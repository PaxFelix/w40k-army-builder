    ...
    const ultramarines = {
        ...
        detachments: [
            ...
            },
            {
                ...
                flavour: "",
                rule: { name: "Mastered Doctrines", flavour: "", text: "", restrictions: "" },
                enhancements: [
                    { name: "Armour of Antoninus", cost: 10, restriction: "ADEPTUS ASTARTES model only.", text: "" },
                    { name: "Oath of Macragge", cost: 15, restriction: "ADEPTUS ASTARTES model only.", text: "" },
                    { name: "Student of the Codex", cost: 20, restriction: "ADEPTUS ASTARTES model only.", text: "" },
                    { name: "Veteran of Behemoth", cost: 25, restriction: "ADEPTUS ASTARTES model only.", text: "" },
                ],
                stratagems: [
                    { name: "Armour of Contempt", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Tactical Foresight", cp: 1, type: "Epic Deed", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Courage and Honour!", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Ultramarian Adaptivity", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Exemplary Vigilance", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Practical Tactics", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            },
            {
                name: "Reclamation Force",
                flavour: "",
                rule: { name: "Oath of Reclamation", flavour: "", text: "", restrictions: "" },
                enhancements: [
                    { name: "Seals of Reconquest", cost: 20, restriction: "ADEPTUS ASTARTES model only.", text: "" },
                    { name: "Avenging Avatar (Aura)", cost: 10, restriction: "ADEPTUS ASTARTES model only.", text: "" },
                    { name: "Scroll of Proclamation", cost: 15, restriction: "ADEPTUS ASTARTES model only.", text: "" },
                    { name: "Liberatum", cost: 25, restriction: "ADEPTUS ASTARTES model only.", text: "" },
                ],
                stratagems: [
                    { name: "Crusading Conquerors", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Furious Dedication", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Fight to the End", cp: 1, type: "Battle Tactic", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Scions of Guilliman", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Ultramarian Destiny", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                    { name: "Marching Ever on", cp: 1, type: "Strategic Ploy", when: "", target: "", effect: "", restrictions: "" },
                ]
            }
        ],
