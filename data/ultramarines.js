    ...
    const ultramarines = {
        ...
        detachments: [
            ...
            },
            {
                ...
                enhancements: [
                    { name: "Armour of Antoninus", cost: 10, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Oath of Macragge", cost: 15, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Student of the Codex", cost: 20, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Veteran of Behemoth", cost: 25, restriction: "ADEPTUS ASTARTES model only." },
                ],
                stratagems: [
                    { name: "Armour of Contempt", cp: 1, type: "Battle Tactic" },
                    { name: "Tactical Foresight", cp: 1, type: "Epic Deed" },
                    { name: "Courage and Honour!", cp: 1, type: "Battle Tactic" },
                    { name: "Ultramarian Adaptivity", cp: 1, type: "Strategic Ploy" },
                    { name: "Exemplary Vigilance", cp: 1, type: "Battle Tactic" },
                    { name: "Practical Tactics", cp: 1, type: "Strategic Ploy" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Seals of Reconquest", cost: 20, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Avenging Avatar (Aura)", cost: 10, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Scroll of Proclamation", cost: 15, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Liberatum", cost: 25, restriction: "ADEPTUS ASTARTES model only." },
                ],
                stratagems: [
                    { name: "Crusading Conquerors", cp: 1, type: "Strategic Ploy" },
                    { name: "Furious Dedication", cp: 1, type: "Battle Tactic" },
                    { name: "Fight to the End", cp: 1, type: "Battle Tactic" },
                    { name: "Scions of Guilliman", cp: 1, type: "Strategic Ploy" },
                    { name: "Ultramarian Destiny", cp: 1, type: "Strategic Ploy" },
                    { name: "Marching Ever on", cp: 1, type: "Strategic Ploy" },
                ]
            }
        ],
