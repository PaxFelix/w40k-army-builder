    ...
    const spaceWolves = {
        ...
        detachments: [
            ...
            },
            {
                ...
                enhancements: [
                    { name: "Swift Hunter", cost: 20, restriction: "SPACE WOLVES model only." },
                    { name: "Fenrisian Grit", cost: 15, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Wolf Master", cost: 5, restriction: "SPACE WOLVES model only." },
                    { name: "Feral Rage", cost: 10, restriction: "ADEPTUS ASTARTES model only." },
                ],
                stratagems: [
                    { name: "Hunters' Trail", cp: 1, type: "Strategic Ploy" },
                    { name: "Territorial Advantage", cp: 1, type: "Strategic Ploy" },
                    { name: "Overwhelming Onslaught", cp: 1, type: "Battle Tactic" },
                    { name: "Chosen Prey", cp: 1, type: "Strategic Ploy" },
                    { name: "Bounding Advance", cp: 1, type: "Strategic Ploy" },
                    { name: "Marked for Destruction", cp: 1, type: "Battle Tactic" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Braggart's Steel", cost: 20, restriction: "SPACE WOLVES model only." },
                    { name: "Skjald", cost: 15, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Hordeslayer", cost: 15, restriction: "SPACE WOLVES model only." },
                    { name: "Thunderwolf's Fortitude", cost: 25, restriction: "ADEPTUS ASTARTES model only." },
                ],
                stratagems: [
                    { name: "Inspiring Presence", cp: 1, type: "Epic Deed" },
                    { name: "Champion's Guidance", cp: 1, type: "Epic Deed" },
                    { name: "Birth of a Saga", cp: 1, type: "Epic Deed" },
                    { name: "Alpha Strike", cp: 1, type: "Epic Deed" },
                    { name: "Heroic Resolve", cp: 2, type: "Epic Deed" },
                    { name: "Countercharge", cp: 2, type: "Epic Deed" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Wolf-touched", cost: 15, restriction: "SPACE WOLVES model only." },
                    { name: "Hunter's Guile", cost: 20, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Elder's Guidance", cost: 20, restriction: "SPACE WOLVES model only." },
                    { name: "Helm of the Beastslayer", cost: 15, restriction: "ADEPTUS ASTARTES model only." },
                ],
                stratagems: [
                    { name: "Unbridled Ferocity", cp: 1, type: "Battle Tactic" },
                    { name: "Shock Cavalry", cp: 1, type: "Strategic Ploy" },
                    { name: "Pinning Fire", cp: 1, type: "Strategic Ploy" },
                    { name: "Thunderous Pursuit", cp: 1, type: "Strategic Ploy" },
                    { name: "Impetuosity", cp: 1, type: "Strategic Ploy" },
                    { name: "Coordinated Strike", cp: 1, type: "Strategic Ploy" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Wolves' Wisdom", cost: 30, restriction: "ADEPTUS ASTARTES INFANTRY model only." },
                    { name: "Foes' Fate", cost: 15, restriction: "ADEPTUS ASTARTES TERMINATOR model only." },
                    { name: "Fangrune Pendant", cost: 15, restriction: "ADEPTUS ASTARTES TERMINATOR model only." },
                    { name: "Longstrider", cost: 20, restriction: "ADEPTUS ASTARTES model only." },
                ],
                stratagems: [
                    { name: "Preytaker's Eye", cp: 1, type: "Strategic Ploy" },
                    { name: "Armour of Contempt", cp: 1, type: "Strategic Ploy" },
                    { name: "Runes of Claiming", cp: 1, type: "Strategic Ploy" },
                    { name: "Chilling Howl", cp: 1, type: "Strategic Ploy" },
                    { name: "Stalking Wolves", cp: 1, type: "Strategic Ploy" },
                    { name: "Onrushing Storm", cp: 1, type: "Strategic Ploy" },
                ]
            },
            {
                ...
                enhancements: [
                    { name: "Grimnar's Mark", cost: 20, restriction: "ADEPTUS ASTARTES TERMINATOR CAPTAIN model only." },
                    { name: "Howlmaw", cost: 15, restriction: "WOLF PRIEST model only." },
                    { name: "Chariots of the Storm", cost: 25, restriction: "ADEPTUS ASTARTES model only." },
                    { name: "Skjald's Foretelling", cost: 25, restriction: "WOLF GUARD BATTLE LEADER model only." },
                ],
                stratagems: [
                    { name: "The Foe Foreseen", cp: 1, type: "" },
                    { name: "Grimnar's Command", cp: 1, type: "" },
                    { name: "Fenrisian Ferocity", cp: 1, type: "" },
                    { name: "Unrelenting Hunters", cp: 1, type: "" },
                    { name: "Eye of the Pack", cp: 1, type: "" },
                    { name: "Battle Instincts", cp: 1, type: "" },
                ]
            }
        ],
